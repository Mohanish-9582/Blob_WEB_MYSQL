...
<html>
    ...
    <body>
        <form action="upload_successful" method="post" enctype="multipart/form-data">
            <h1>Welcome to Upload Documents</h1>
            Name of the Document : 
            <input type="text" placeholder="Enter your Name" name="a" required>
            <br>
            <br>
            Enter your Id : 
            <input type="number" placeholder="Enter Id" name="b" required>
            <br>
            <br>
            Choose Files : 
            <input type="file" value="Choose File" accept="image/png, image/jpeg" name="c" required="">
            <br>
            <br>
